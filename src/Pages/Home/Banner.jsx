    ...
    return (
        <div>
            ...
            <section className="bg-white">
                <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center px-4 py-12 gap-10">
                    {/* Left Content */}
                    <motion.div
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-bold text-[#865B97] mb-6">
