                ...
                <div className="card-body">
                    <form onSubmit={handleRegister} className="form-control w-full">
                        ...
                        <input
                            ...
                            name="image"
                            accept="image/*"
                            className="file-input w-full border border-[#8A4771]"
                            required
                        />
                        ...
                        <button
                            type="submit"
                            className="btn btn-block mt-4 bg-[#865B97] text-white font-bold"
                        >
                            Register
                        </button>
                        ...
                        <p className="text-center mt-2">
                            ...
                            <Link
                                to="/login"
                                className="link link-hover underline text-blue-500 font-semibold"
                            >
                                Log in
                            </Link>
                        </p>
